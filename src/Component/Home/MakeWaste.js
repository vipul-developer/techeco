...
const MakeWaste = () => {
    return (
        <>
            <Grid container>
                <Fade direction='up' triggerOnce style={{textAlign:"center",width:"100%"}}>
                    <Grid item xs={12}>
                        <Container fixed>
                ...
                <Container fixed>
                    <Grid container item xl={12} lg={12} md={12} sm={12} xs={12} spacing={2}>
                        <Grid item xl={3} lg={3} md={3} sm={3} xs={12}>
                            <Card sx={{minWidth:{lg:"328.5px",md:"240px"},borderRadius:"12px"}}>
                                <CardMedia
                                    component="img"
                                    height="503"
                                    image={JohnCameron}
                        ...
                        <Grid item xl={3} lg={3} md={3} sm={3} xs={12}>
                            <Card sx={{minWidth:{lg:"328.5px",md:"240px"},background:" linear-gradient(90deg, rgba(14,81,86,1) 0%, rgba(51,188,130,1) 50%)",margin:{md:"0 0 0 50px"},borderRadius:"12px"}}>
                                <CardContent sx={{p:0}}>
                            ...
                            <Card sx={{minWidth:{lg:"328.5px",md:"240px"},background:" linear-gradient(90deg, rgba(14,81,86,1) 0%, rgba(51,188,130,1) 50%)",margin:{md:"15px 0 0 50px"},borderRadius:"12px"}}>
                                <CardContent sx={{p:0}}>
